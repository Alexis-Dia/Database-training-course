1. Создать представление, содержащее полную информацию о журнале выездов. С
помощью созданного представления определить фамилию водителя, имеющего
наибольший километраж поездок.
2. Создать представление, содержащее информацию о количестве выездов по датам.
С помощью созданного представления определить даты, когда число выездов было выше
среднего.
3. Создать представление, содержащее информацию о среднем километраже выездов
каждого водителя за месяц. С помощью созданного представления определить фамилии
водителей, имеющих наименьший километраж и наибольший средний километраж.
4. Создать представление, содержащее информацию об использовании автомобилей за
прошедший месяц. С помощью созданного представления определить автомобиль,
