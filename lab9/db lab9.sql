1. Создать скалярную функцию для вычисления возраста автомобиля по вводимому
номеру автомобиля.
2. Создать табличную функцию для вывода списка автомобилей, запланированных в
рейс на вводимую дату.
3. Создать многострочную табличную функцию для формирования графика выездов
на следующую неделю с указанием фамилий водителей, марок и номеров
автомобилей.
